...
write.csv(eQTL$trans$eqtls, "../../Input_Output/eQTL_result/LINEAR_CROSS/mRNA/covariate_diagnosissubtype_sex_race_age_hypertension_diabates_cholestrolemia _diagnosis/eQTL_trans_1e6.csv") # highest number of eQTL pass FDR here
```
